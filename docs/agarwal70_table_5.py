...
pwD1 = agarwal1970.pressure_lineSource(tD,1e2,0)
pwD2 = agarwal1970.pressure_lineSource(tD,1e3,0)
pwD3 = agarwal1970.pressure_lineSource(tD,1e4,0)
pwD4 = agarwal1970.pressure_lineSource(tD,1e5,0)
