...
pwD1 = agarwal1970.pressure_lineSource(tD,1e2,10)
pwD2 = agarwal1970.pressure_lineSource(tD,1e3,10)
pwD3 = agarwal1970.pressure_lineSource(tD,1e4,10)
pwD4 = agarwal1970.pressure_lineSource(tD,1e5,10)
