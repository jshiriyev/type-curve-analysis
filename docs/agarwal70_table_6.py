...
pwD1 = agarwal1970.pressure_lineSource(tD,1e2,5)
pwD2 = agarwal1970.pressure_lineSource(tD,1e3,5)
pwD3 = agarwal1970.pressure_lineSource(tD,1e4,5)
pwD4 = agarwal1970.pressure_lineSource(tD,1e5,5)
